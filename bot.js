...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' Army Commuinty',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' BAD Is The Best ','Just Do It'];
    var i = -1;
    var j = 0;
...
client.login(NjEyMDEyOTUzNjgzNjIzOTM2.XVgdwg.HxsMY8vYdVTBtAEQYn15i6ZTMqg);
